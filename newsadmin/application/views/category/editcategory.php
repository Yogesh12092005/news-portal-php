						...
						<section class="boxs">
							<div class="boxs-header">
								<h3 class="custom-font hb-blush">
									<strong>Edit</strong> Category</h3>
							</div>
							<div class="boxs-body">
								<form class="form-horizontal" enctype="multipart/form-data" name="form4" role="form" id="form4" method="post" action="<?php echo site_url() ?>/categorycontroller/up_category/<?php echo $data->cid ?>" data-parsley-validate>
						
                                    <div class="form-group">
										<label class="col-sm-3 control-label">Category</label>
										<div class="col-sm-9">
											<input type="text" name="category" class="form-control" value="<?php echo $data->category ?>" placeholder="Add Category" data-parsley-trigger="change" required>
										</div>
									</div>
