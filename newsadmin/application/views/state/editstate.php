						...
						<section class="boxs">
							<div class="boxs-header">
								<h3 class="custom-font hb-blush">
									<strong>Edit</strong> State</h3>
							</div>
							<div class="boxs-body">
								<form class="form-horizontal" enctype="multipart/form-data" name="form4" role="form" id="form4" method="post" action="<?php echo site_url() ?>/statecontroller/up_state/<?php echo $data->stateid ?>" data-parsley-validate>
						
								<div class="form-group">
										<label class="col-sm-3 control-label">CountryID</label>
										<div class="col-sm-9">
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="sname" class="form-control" value="<?php echo $data->sname ?>" placeholder="State Name" data-parsley-trigger="change" required>
										</div>
									</div>
									<hr class="line-dashed full-witdh-line" />
