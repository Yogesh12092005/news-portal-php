						...
						<section class="boxs">
							<div class="boxs-header">
								<h3 class="custom-font hb-blush">
									<strong>Edit</strong> Subscriber</h3>
							</div>
							<div class="boxs-body">
								<form class="form-horizontal" enctype="multipart/form-data" name="form4" role="form" id="form4" method="post" action="<?php echo site_url() ?>/subscribercontroller/up_subscriber/<?php echo $data->subid ?>" data-parsley-validate>
						
                                    <div class="form-group">
										<label class="col-sm-3 control-label">Email</label>
										<div class="col-sm-9">
											<input type="text" name="semail" class="form-control" value="<?php echo $data->semail ?>" placeholder="Email" data-parsley-trigger="change" required>
										</div>
									</div>
