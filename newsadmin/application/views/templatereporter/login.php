...
<body id="falcon" class="authentication">
  <div class="wrapper">
    <!-- <div class="header header-filter" style="background-image: url('?php echo base_url() ?>assets/images/login1.jpg'); background-size: cover; background-position: top center;"> -->
      <div class="container">
        <div class="row">
          <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 text-center">
            <div class="card card-signup">
              ...
              <form class="form" id="adminlogin" style="display: none;" method="post" action="<?php echo site_url() ?>/homecontroller/checklogin">
                ...
                <a href="<?php echo site_url('homecontroller/repforget'); ?>">Forgot Password?</a>
              </form>
