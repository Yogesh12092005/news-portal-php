						...
						<section class="boxs">
							<div class="boxs-header">
								<h3 class="custom-font hb-blush">
									<strong>Edit</strong> Post Rating</h3>
							</div>
							<div class="boxs-body">
								<form class="form-horizontal" enctype="multipart/form-data" name="form4" role="form" id="form4" method="post" action="<?php echo site_url() ?>/postratingcontroller/up_postrating/<?php echo $data->ratid ?>" data-parsley-validate>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="uemail" class="form-control" value="<?php echo $data->uemail ?>" placeholder="User Email" data-parsley-trigger="change" required>
										</div>
									</div>
									<hr class="line-dashed full-witdh-line" />
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="ratlike" class="form-control" value="<?php echo $data->ratlike ?>" placeholder="Rating" data-parsley-trigger="change" required>
										</div>
									</div>
									<hr class="line-dashed full-witdh-line" />
