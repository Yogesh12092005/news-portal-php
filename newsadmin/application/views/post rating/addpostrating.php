				...
				<div class="bg-light lter b-b wrapper-md mb-10">
					<div class="row">
						<div class="col-sm-6 col-xs-12">
							<h1 class="h3 m-0">Post Rating Form</h1>
						...
						<section class="boxs">
							<div class="boxs-header">
								<h3 class="custom-font hb-blush">
									<strong>Add</strong> Post Rating</h3>
							</div>
							<div class="boxs-body">
								<form class="form-horizontal" enctype="multipart/form-data" name="form4" role="form" id="form4" method="post" action="<?php echo site_url() ?>/postratingcontroller/inspostrating" data-parsley-validate>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="uemail" class="form-control" placeholder="User Email" data-parsley-trigger="change" required>
										</div>
									</div>
									<hr class="line-dashed full-witdh-line" />
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="ratlike" class="form-control" placeholder="Rating" data-parsley-trigger="change" required>
										</div>
									</div>
									<hr class="line-dashed full-witdh-line" />
