				...
				<div class="bg-light lter b-b wrapper-md mb-10">
					<div class="row">
						<div class="col-sm-6 col-xs-12">
							<h1 class="h3 m-0">Reporter Chat Form</h1>
						...
						<section class="boxs">
							<div class="boxs-header">
								<h3 class="custom-font hb-blush">
									<strong>Add</strong> Reporter Chat</h3>
							</div>
							<div class="boxs-body">
								<form class="form-horizontal" enctype="multipart/form-data" name="form4" role="form" id="form4" method="post" action="<?php echo site_url() ?>/reporterchatcontroller/insreporterchat" data-parsley-validate>
								...
								<div class="form-group">
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="reportermsg" class="form-control" placeholder="Reporter Message" data-parsley-trigger="change" required>
										</div>
									</div>
									<hr class="line-dashed full-witdh-line" />
