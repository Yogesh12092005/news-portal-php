						...
						<section class="boxs">
							<div class="boxs-header">
								<h3 class="custom-font hb-blush">
									<strong>Edit</strong> City</h3>
							</div>
							<div class="boxs-body">
								<form class="form-horizontal" enctype="multipart/form-data" name="form4" role="form" id="form4" method="post" action="<?php echo site_url() ?>/citycontroller/up_city/<?php echo $data->cityid ?>" data-parsley-validate>
									
								<hr class="line-dashed full-witdh-line" />

									  <div class="form-group">
										<label class="col-sm-3 control-label">Country Id</label>
										<div class="col-sm-9">
										...
										<?php
										$rep=$this->db->get('country')->result();
										foreach($rep as $r)
										{
											?>
								...
								<div class="form-group">
										<label class="col-sm-3 control-label">State Id </label>
										<div class="col-sm-9">
										...
										<?php
										$rep=$this->db->get('state')->result();
										foreach($rep as $r)
										{
											?>
											<option value="<?php echo $r->stateid  ?>"><?php echo $r->sname ?></option>
											<?php
										}	
										?>
										</select>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="cname" class="form-control" value="<?php echo $data->cname ?>" placeholder="Add City Name" data-parsley-trigger="change" required>
										</div>
									</div>
									<hr class="line-dashed full-witdh-line" />
