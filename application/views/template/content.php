		...
		<section class="heading-news">
			...
			<div class="iso-call heading-news-box">
				...
				<div class="image-slider snd-size">
					<span class="top-stories">Slider</span>
					...
					<ul class="bxslider">
						...
						<li>
							<div class="news-post image-post">
								<img src="<?php echo base_url() ?>/newsadmin/imgupload/<?php echo $sliderData->slider_image ?>" alt="">
								<div class="hover-box">
									<div class="inner-hover">
										<a class="category-post world" href="world.html"><?php echo $sliderData->slidertitle ?></a>
										<h2><a href="single-post.html"><?php echo $sliderData->	sliderdesc ?> </a></h2>
										<ul class="post-tags">
											<li><i class="fa fa-clock-o"></i><?php echo $sliderData->sdatereg?></li>
											<li><i class="fa fa-user"></i>by <a href="#"><?php echo $sliderData->sliderid?></a></li>
											<li><a href="#"><i class="fa fa-comments-o"></i><span>23</span></a></li>
		...
		<section class="ticker-news">
			...
			<div class="container">
				<div class="ticker-news-box">
                    ...
                    <?php
                    foreach($breaking as $breakingData)
                    {
                    ?>
                    <li class="news-item"><span class="time-news"><?php echo $breakingData->datereg; ?></span>  <a href="#"><?php echo $breakingData->description; ?></a> </li>
					<?php
                    }
                    ?>
